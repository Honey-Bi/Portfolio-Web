...
function Project() {
  ...
  function renderProject(min: number, max: number, count: number): JSX.Element {
    ...
    if (data.demo !== null) {
      links.push(
        <a href={data.demo} key={data.demo} target="_blank" rel="noreferrer">
          Demo
        </a>
      );
    }
    ...
    return (
      <>
        <div
          className={`project-item ${count < depth ? "active" : ""}`}
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="project-link">{links}</div>
            </div>
          </div>
        </div>
        <div
          className={`project-list ${count < depth ? active[index % 4] : ""}`}
          style={{
            width: width,
            height: height,
      ...
      <div id="down" className="down-height project" ref={baseRef} onWheel={moveWheel}>
        ...
        >
          <div className="project-view" ref={viewRef}>
            <div
              className={`project-item disabled ${0 < depth ? "active" : ""}`}
            ...
            >
              ...
              >
                <div
                  className="project-content"
                  style={{ transform: `rotate(${isShort ? "-90" : "0"}deg)` }}
                >
            ...
            <div
              className={`project-list 0 ${0 < depth ? "active1" : ""}`}
              style={{
                width: size.max - size.min,
                height: size.min,
