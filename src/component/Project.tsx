...
function Project() {
    ...
    function renderProject(min:number, max:number, count:number): JSX.Element {
        ...
        if (data.demo !== null) {
            links.push(
                <a href={data.demo} key={data.demo} target="_blank" rel="noreferrer">Demo</a>
            )
        }
            ...
            style={{width:min, height:min}}>
                ...
                style={{width: size.min, height: size.min,
                    ...
                    style={{
                        ...
                        <button className="project-about" disabled={depth >= count?false:true} onClick={e => move(e, data.title, data.color, index)}>
    ...
    function moveWheel(e: React.WheelEvent) { // 마우스 휠 핸들러
                ...
                <div className="project-view" ref={viewRef}>
                    <div className={`project-item disabled ${0 < depth?'active':''}`} 
                        ...
                        onClick={e => select(e, 0)}>
                            <div className="project-scale"
                                style={{width: size.min, height: size.min}}>
                                <div className="project-content" style={{transform: `rotate(${isShort?'-90':'0'}deg)`}}>
